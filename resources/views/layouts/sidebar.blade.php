    ...
    <body class="all_content">
        <div class="d-flex">
            <div class="sidebar">
                ...
                <p><i class="bi bi-door-open"></i></i><a href="/logout">ログアウト</a></p>
                <p><i class="bi bi-calendar3"></i><a href="{{ route('calendar.general.show',['user_id' => Auth::id()]) }}">スクール予約</a></p>
                @can('admin')
                    <p><i class="bi bi-calendar-check"></i><a href="{{ route('calendar.admin.show',['user_id' => Auth::id()]) }}">スクール予約確認</a></p>
                    <p><i class="bi bi-calendar4"></i><a href="{{ route('calendar.admin.setting',['user_id' => Auth::id()]) }}">スクール枠登録</a></p>
                @endcan
