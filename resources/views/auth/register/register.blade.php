...
<!--━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━-->
<!-- ◆ 登録画面/guest (RegisterUserController create関数)                  -->
<!--━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━-->
  <form action="{{ route('registerPost') }}" method="POST">
    <div class="w-100 vh-100 d-flex guest_container" style="align-items:center; justify-content:center;">
      <div class="vh-75 border guest_form_area guest_register shadow">
        ...
        <div class="register_form">
          ...
          <div class="d-flex mt-3" style="justify-content:space-between">
            ...
            <!--◇姓の記入欄-->
            <div class="name_flex_item">
              @if($errors->first('over_name'))
                <span class="error_message">{{ $errors->first('over_name') }}</span>
              @endif

              <label class="d-block m-0" style="font-size:13px">姓</label>
              <div class="border-bottom border-primary name_flex_item">
                <input type="text" class="name_flex_item border-0 over_name" name="over_name">
              </div>
            </div>
            ...
            <div class="name_flex_item">
              ...
              <div class="border-bottom border-primary name_flex_item">
                <input type="text" class="name_flex_item border-0 under_name" name="under_name">
              </div>
            </div>
          </div>
          ...
          <div class="d-flex mt-3" style="justify-content:space-between">
            ...
            <div class="name_flex_item">
              ...
              <div class="border-bottom border-primary name_flex_item">
                <input type="text" class="name_flex_item border-0 over_name_kana" name="over_name_kana">
              </div>
            </div>
            ...
            <div class="name_flex_item">
              ...
              <div class="border-bottom border-primary name_flex_item">
                <input type="text" class="name_flex_item border-0 under_name_kana" name="under_name_kana">
              </div>
            </div>
          </div>
        ...
        <div class="mt-3">
          ...
          <!--◆年-->
          <div class="border-bottom border-primary birth_selectbox">
            <select class="old_year border-0 birth_selectbox" name="old_year">
          ...
          <!--◆月-->
          <div class="border-bottom border-primary birth_selectbox">
            <select class="border-0 old_month birth_selectbox" name="old_month">
              <option value="none">-----</option>
          ...
          <!--◆日付-->
          <div class="border-bottom border-primary birth_selectbox">
            <select class="border-0 old_day birth_selectbox" name="old_day">
              <option value="none">-----</option>
              <option value="01">1</option>
              <option value="02">2</option>
              <option value="03">3</option>
        ...
        <!-- ◆ 選択科目エリア                                                      -->
        <!--━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━-->
        <div class="select_teacher d-none mt-2">
